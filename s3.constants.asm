...
Got_Lightning_Shield_Sfx = sfx_LightningShield
Fire_Shield_Sfx          = sfx_FireAttack
Hyper_Form_Change_Sfx    = sfx_Whistle
Grab_Sfx                 = sfx_Blast
Waterfall_Splash_Sfx     = sfx_WaterfallSplash
Projectile_Sfx           = sfx_Projectile
Missile_Explosion_Sfx    = sfx_MissileExplode
...
Fan_Big_Sfx              = sfx_BossRotate
Sfx_61                   = sfx_FanLatch
Smash_Sfx                = sfx_Collapse
Switch_Blip_Sfx          = sfx_Switch
Floor_Thump_Sfx          = sfx_FloorThump
Crash_Sfx                = sfx_Crash
Jump_Sfx                 = sfx_Jump
Level_Projectile_Sfx     = sfx_LevelProjectile
Underwater_Sfx           = sfx_ActionBlock
Boss_Hit_Sfx             = sfx_BossHit
